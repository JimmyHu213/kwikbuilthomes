...
import { submitQuote, type QuoteActionState } from '@/lib/actions/submit-quote'
import { australianStates, timelineOptions } from '@/lib/schemas/quote-schema'
...
export function QuoteForm({
  ...
  return (
    <form action={formAction} className="space-y-8">
      ...
      <input type="hidden" name="selectedOptions" value={selectedOptions} />
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            {state.errors?.contactName && (
              <p className={errorClassName}>{state.errors.contactName[0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            {state.errors?.contactEmail && (
              <p className={errorClassName}>{state.errors.contactEmail[0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            {state.errors?.contactPhone && (
              <p className={errorClassName}>{state.errors.contactPhone[0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            {state.errors?.company && (
              <p className={errorClassName}>{state.errors.company[0]}</p>
            )}
          </div>
        </div>
      </fieldset>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            {state.errors?.quantity && (
              <p className={errorClassName}>{state.errors.quantity[0]}</p>
            )}
          </div>

          <div>
            <label htmlFor="deliveryState" className={labelClassName}>
            ...
            {state.errors?.deliveryState && (
              <p className={errorClassName}>{state.errors.deliveryState[0]}</p>
            )}
          </div>

          <div>
            <label htmlFor="deliveryLocation" className={labelClassName}>
              Delivery Location
            </label>
            <input
              id="deliveryLocation"
          ...
          <div>
            <label htmlFor="projectTimeline" className={labelClassName}>
              Project Timeline
            </label>
            <select
              id="projectTimeline"
          ...
          <div className="sm:col-span-2">
            <label htmlFor="siteConditions" className={labelClassName}>
              Site Conditions
            </label>
            <textarea
              id="siteConditions"
              ...
              rows={3}
              className={inputClassName}
              placeholder="Describe site access, terrain, services availability..."
            />
          </div>
        </div>
      </fieldset>
        ...
        <div className="space-y-4">
          ...
          {isEstateInquiry && (
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 pl-7">
              <div>
                <label htmlFor="numberOfUnits" className={labelClassName}>
                  Number of Units
                </label>
                <input
                  id="numberOfUnits"
              ...
              <div className="sm:col-span-2">
                <label htmlFor="siteAddress" className={labelClassName}>
                  Site Address
                </label>
                <textarea
                  id="siteAddress"
                  ...
                  rows={2}
                  className={inputClassName}
                  placeholder="Site or development address"
                />
              </div>

              <div className="sm:col-span-2">
                <label htmlFor="modelMix" className={labelClassName}>
                  Model Mix
                </label>
                <textarea
                  id="modelMix"
                  ...
                  rows={2}
                  className={inputClassName}
                  placeholder="e.g., 4x Studio 35, 2x Family 60"
                />
              </div>
            </div>
          )}
      ...
      <fieldset>
        ...
        <textarea
          ...
          rows={4}
          className={inputClassName}
          placeholder="Any other requirements, questions, or details..."
        />
      </fieldset>
