  ...
  return {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h1 style="color: #1a1a1a; font-size: 24px; margin-bottom: 16px;">Thank You, ${data.contactName}!</h1>
        <p style="color: #333; font-size: 16px;">We&rsquo;ve received your Site Planner quote request with reference <strong>${data.referenceNumber}</strong>.</p>
